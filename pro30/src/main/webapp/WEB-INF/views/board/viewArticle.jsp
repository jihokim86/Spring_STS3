...
<!-- 글목록 클릭시 /board/viewArticle.do를 거쳐  
		articleVO=boardService.viewArticle(articleNO); articleNO에 따른 레코드.
...
<head>
   ...
   <script type="text/javascript" >
	 ...
	 function fn_enable(obj){
		 ...
		 document.getElementById("tr_file_upload").style.display="visible";
		 ocument.getElementById("tr_file_upload2").style.visibility="visible"; 
